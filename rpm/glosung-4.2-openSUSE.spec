...
URL:            https://godehardt.org/losung.html
BuildRoot:      %{_tmppath}/%{name}-buildroot
Requires:       gtk4 >= 4.12.4
Requires:       libadwaita-1-0 >= 1.4.2
Requires:       libxml2 >= 2.10.3
Requires:       libcurl4 >= 8.14.1
Requires:       unzip >= 6.00
Requires:       xdg-utils >= 1.1.3+20210805
BuildRequires:  gtk4-devel >= 4.12.4
BuildRequires:  glib2-devel >= 2.78.6
BuildRequires:  libadwaita-devel >= 1.4.2
BuildRequires:  libxml2-devel >= 2.10.3
BuildRequires:  libcurl-devel >= 8.14.1
BuildRequires:  gettext-tools >= 0.21.1
Prefix:         %{_prefix}
BuildArchitectures: x86_64
Distribution:   openSUSE (x86_64)
License:        GPL
# This Software is copyright (c) 1999-2026 by Eicke Godehardt.
...
%changelog
* Sat Jan 10 2026 Eicke
- release 4.2
- improve GTK4 deprecations / GTK4 updates
- support for current distributions, e.g. Ubuntu 24.10+ or ​​Debian 13 "trixie"

* Fri Oct 25 2024 Eicke
- release 4.1
- support Ubuntu 24.4
- migrate from deprecated settings backend
- offer scalable icon
