...
Requires:       gtk4 >= 4.16.13
Requires:       libadwaita >= 1.6.10
Requires:       libxml2 >= 2.12.10
Requires:       libcurl-minimal >= 8.9.1
Requires:       unzip >= 6.0
Requires:       xdg-utils >= 1.2.1
BuildRequires:  gtk4-devel >= 4.16.13
BuildRequires:  glib2-devel >= 2.82.5
BuildRequires:  libadwaita-devel >= 1.6.10
BuildRequires:  libxml2-devel >= 2.12.10
BuildRequires:  libcurl-devel >= 8.9.1
BuildRequires:  gettext >= 0.22.5
Prefix:         %{_prefix}
