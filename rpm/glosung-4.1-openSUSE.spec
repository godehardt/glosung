...
Requires:       gtk4 >= 4.12
Requires:       libadwaita-1-0 >= 1.4
Requires:       libxml2 >= 2.10
Requires:       libcurl4 >= 8.6
Requires:       unzip >= 6.00
Requires:       xdg-utils >= 1.1.3+20210805
BuildRequires:  gtk4-devel >= 4.12
BuildRequires:  glib2-devel >= 2.78
BuildRequires:  libadwaita-devel >= 1.4
BuildRequires:  libxml2-devel >= 2.10
BuildRequires:  libcurl-devel >= 8.6
